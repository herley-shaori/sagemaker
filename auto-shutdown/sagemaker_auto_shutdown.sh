...
# aws s3 --endpoint-url [S3 Interface Endpoint] cp s3://sagemaker-auto-shutdown-package/sagemaker_studio_autoshutdown-0.1.5.tar.gz .auto-shutdown/extension.tar.gz
aws s3 cp s3://sagemaker-auto-shutdown-package/sagemaker_studio_autoshutdown-0.1.5.tar.gz .auto-shutdown/extension.tar.gz
